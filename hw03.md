...
　　
<center>
![](images\QQ截图20181007225340.png)
</center>

2)Int8_t x = - 017; 请用8进制描述变量 x。在c中017即(017)<sub>8</sub>


　　由于8<sup>8+1</sup> = (1,0000,0000)<sub>8</sub> , 故由模运算可知 , - 107 = (1,0000,0000 - 0000,0017)<sub>8</sub> = (7777,7761)<sub>8</sub> 。

*阅读维基百科” Two‘s complement”的内容，特别是Sign extension小节内容。*

1)C程序：int8_t x = -0x1f; int y = x; 请用16进制描述变量 x 和 y，并说明 int y = x 的计算过程。

　　x = -0x1f , x转化为十进制为 -31 , 二进制原码为 1001,1111 , 补码为 1110,0001, 转化为16进制即为(e1)<sub>16</sub> , 
...
　　由二进制位置表示法: D = d<sub>n</sub>*2<sup>n-1</sup>+...+d<sub>1</sub>*2<sup>0</sup> , 再由Sign extension, 于D的二进制表示左边可添加适量的“ 0 ”，使得n为4的倍数，那么就有 D = d<sub>4n</sub>*2<sup>4n-1</sup>+...+d<sub>1</sub>*2<sup>0</sup>,此时，D = (d<sub>4n</sub>*2<sup>3</sup> + d<sub>4n-1</sub>*2<sup>2</sup> + d<sub>4n-2</sub>*2<sup>1</sup> + d<sub>4n-3</sub>*2<sup>0</sup>)*16<sup>n-1</sup> + ... + (d<sub>4</sub>*2<sup>3</sup> + d<sub>3</sub>*2<sup>2</sup> + d<sub>2</sub>*2<sup>1</sup> + d<sub>1</sub>*2<sup>0</sup>)*16<sup>0</sup> , 且有d<sun>n</sub>等于0或1，所以上式括号中的数可取 0 ~ 15 , 符合十六进制位置表示法，故通过上述证明，可以在Sign extension后，每取4位(二进制中)对应1位(十六进制中)。

<center>
![](images\QQ截图20181008073242.png)
</center>
