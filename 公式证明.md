...
$\therefore$ 
$$(d)_{r0} = \sum_{i=1}^{n}d_{i}r_1^{i-1} = d_{n}r_1^{n-1} + d_{n-1}r_1^{n-2} + ··· + d_{3}r_1^{2} + d_{2}r_1 + d_{1} 
= r(d_{n}r_1^{n-2} +d_{n-1}r_1^{n-3} + ··· + d_{3}r_1 + d_{2}) + d_{1} = r(r(d_{n}r_1^{n-3} +d_{n-1}r_1^{n-4} + ··· + d_{4}r_1 + d_{3}) + d_{2}) + d_{1}$$
